...
import { crearCategoriaMaterial, editarCategoriaMaterial } from "./actions"
    ...
    const handleSubmit = async (formData: FormData) => {
        startTransition(async () => {
            const res = esEdicion && categoria
                ? await editarCategoriaMaterial(categoria.id, formData)
                : await crearCategoriaMaterial(formData)
