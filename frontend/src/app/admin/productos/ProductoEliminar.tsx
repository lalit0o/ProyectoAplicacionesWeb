...
interface Props{
    producto: Producto;
    onClose: () => void; // para cerrar el modal después de eliminar
}

export default function ProductoEliminar({ producto, onClose }: Props) {
    ...
    const handleEliminar = () => {
        startTransition(async () => {
            ...
            if (res.success) {
                ...
                setErrorMsg(res.error ?? "Error desconocido al eliminar el producto.")
            }
        })
    }
        ...
        <div className="space-y-6">
            ...
            {errorMsg ? (
                ...
                <p className="text-sm text-zinc-500 leading-relaxed">
                    ...
                    <span className="font-bold text-zinc-900">{producto.titulo}</span>
                    {" "}del catálogo?
                </p>
            )}
